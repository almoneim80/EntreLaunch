namespace EntreLaunch.Infrastructure.StaticContentInfra
{
    public static class StaticContentDefaults
    {
        ...
        { StaticContentKeys.HomePage.HeroDescription, "منصة EntreLaunch لريادة الأعمال وتطوير المشاريع" },
        ...
        { StaticContentKeys.Footer.About, "منصة EntreLaunch تهدف إلى دعم رواد الأعمال وتحفيز الابتكار." },
        { StaticContentKeys.Footer.Contact, "اتصل بنا لأي استفسار أو دعم فني." },
        { StaticContentKeys.Footer.Copyright, "© جميع الحقوق محفوظة لمنصة EntreLaunch" },
        ...
        { StaticContentKeys.HomePage.HeroDescription, "EntreLaunch is a platform for entrepreneurship and project development." },
        { StaticContentKeys.HomePage.BannerImage, "/images/home/banner.jpg" },
        ...
        { StaticContentKeys.Footer.About, "EntreLaunch aims to support entrepreneurs and foster innovation." },
        { StaticContentKeys.Footer.Contact, "Contact us for inquiries or technical support." },
        { StaticContentKeys.Footer.Copyright, "© All rights reserved to EntreLaunch platform" },
