...
{
    public int TrialMaxDays { get; set; } = 7;
    public int ClubDurationInDays { get; set; } = 30;
    public int MyTeamDurationInDays { get; set; } = 30;
    public int MyFinanceDurationInDays { get; set; } = 30;
    public int MyPartnerDurationInDays { get; set; } = 30;
    public int MyOpportunityDurationInDays { get; set; } = 30;
    public int TrainingPathDurationInDays { get; set; } = 30;
}
