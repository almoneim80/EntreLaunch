...
namespace EntreLaunch.Formatters.Csv;

public class CsvInputFormatter : InputFormatter
{
    public CsvInputFormatter()
    {
        SEntreLaunchportedMediaTypes.Add(Microsoft.Net.Http.Headers.MediaTypeHeaderValue.Parse("text/csv"));
    }
    ...
    public override async Task<InputFormatterResult> ReadRequestBodyAsync(InputFormatterContext context)
    {
        ...
        Microsoft.Net.Http.Headers.MediaTypeHeaderValue.TryParse(request.ContentType, out var requestContentType);
    ...
    protected async Task<object> ReadStreamAsync(Type type, Stream stream)
    {
        ...
        using (var csv = new CsvReader(reader, CultureInfo.InvariantCulture))
        {
            ...
            csv.Context.TypeConverterCache.RemoveConverter<DateTimeOffset?>();
            csv.Context.TypeConverterCache.AddConverter<DateTimeOffset?>(new NullableDateTimeToUtcConverter(typeof(DateTimeOffset?), csv.Context.TypeConverterCache));
...
public class NullableDateTimeToUtcConverter : CsvHelper.TypeConversion.NullableConverter
{
