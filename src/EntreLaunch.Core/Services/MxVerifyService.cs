...
/// <summary>
/// Service for checking MX records.
/// </summary>
    ...
    public async Task<bool> Verify(string mxValue)
    {
        ...
        try
        {
            ...
            if (mailServer != null)
            {
                ...
                else if ((mailServer.EntreLaunchdatedAt ?? mailServer.CreatedAt) > DateTime.Now.AddMonths(-1))
                {
...
/// <summary>
/// StreamReaderExtension class that extends the StreamReader class.
/// </summary>
