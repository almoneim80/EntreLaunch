...
namespace EntreLaunch.Services.CacheSvc
{
    public class MemoryCacheService : ICacheService
    {
        ...
        {
            if (_memoryCache is MemoryCache memoryCacheImpl)
            {
                var entries = memoryCacheImpl
                    .GetType()
                    .GetField("_entries", BindingFlags.NonPublic | BindingFlags.Instance)
                    ?.GetValue(memoryCacheImpl) as IDictionary;
