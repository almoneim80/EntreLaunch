        ...
        ILocalizationManager localizationManager)
    {
        ...
        public async Task<GeneralResult<bool>> SoftDeleteCascadeAsync<T>(int id) where T : SharedData
        {
            ...
            catch (Exception ex)
            {
                ...
                return new GeneralResult<bool>(false, _localizationManager.GetLocalizedString("ErrorCascadingSoftDelete"), false);
            }
        }
        ...
        /// <summary>
        /// Updates the cache for the specified entity.
        /// </summary>
        ...
        /// <summary>
        /// Updates the cache for the specified user.
        /// </summary>
