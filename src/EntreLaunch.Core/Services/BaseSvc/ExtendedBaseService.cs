...
{
    public class ExtendedBaseService(IDbContextFactory<PgDbContext> dbContextFactory, ILogger<ExtendedBaseService> logger, ILocalizationManager localizationManager) : IExtendedBaseService
    {
