...
namespace EntreLaunch.Services.EmailSvc
{
    public class EmailService : IEmailService
    {
        ...
        public EmailService(IConfiguration configuration, ILogger<EmailService> logger, ILocalizationManager localizationManager)
        {
        ...
        public async Task<GeneralResult<string>> SendAsync(string subject, string fromEmail, string fromName, string[] recipients, string body, List<AttachmentDto>? attachments)
        {
            ...
            try
            {
                ...
                return new GeneralResult<string>(true, _localizationManager.GetLocalizedString("EmailSentSuccessfully"), message.MessageId);
            }
            catch (Exception exception)
            {
                ...
                switch (exception)
                {
                    ...
                    case ServiceNotAuthenticatedException:
                        ...
                        return new GeneralResult<string>(false, _localizationManager.GetLocalizedString("SmtpAuthenticationError"), null);
                    case ServiceNotConnectedException:
                        _logger.LogError(exception, "Error connecting to smtp host");
                        return new GeneralResult<string>(false, _localizationManager.GetLocalizedString("SmtpConnectionError"), null);
                    default:
                        _logger.LogError(exception, "Error sending email");
                        return new GeneralResult<string>(false, _localizationManager.GetLocalizedString("EmailSendError"), null);
                }
            }
            finally
            {
