...
namespace EntreLaunch.Services.EmailSvc
{
    public class DomainService : IDomainService
    {
        ...
        public DomainService(PgDbContext pgDbContext, IMxVerifyService mxVerifyService, IMapper mapper, ILocalizationManager localizationManager)
        {
        ...
        public async Task<GeneralResult<DomainDetailsDto>> VerifyDomainAsync(string name, bool force)
        {
            ...
            return new GeneralResult<DomainDetailsDto>(true, _localizationManager.GetLocalizedString("DomainVerifiedSuccessfully"), _mapper.Map<DomainDetailsDto>(domain));
        }
