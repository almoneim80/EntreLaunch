namespace EntreLaunch.Services
{
    public class LocalizationManager : ILocalizationManager
    {
        ...
        private const string RatingsPath = "Up.Localization.Ratings.";
        private const string CulturesPath = "Up.Localization.iso6392.txt";
        private const string CountriesPath = "Up.Localization.countries.json";
