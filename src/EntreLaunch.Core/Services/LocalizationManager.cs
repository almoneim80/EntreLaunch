namespace EntreLaunch.Services
{
    public class LocalizationManager : ILocalizationManager
    {
        ...
        private const string RatingsPath = "EntreLaunch.Localization.Ratings.";
        private const string CulturesPath = "EntreLaunch.Localization.iso6392.txt";
        private const string CountriesPath = "EntreLaunch.Localization.countries.json";
        ...
        /// <summary>
        /// Load all parental ratings from the assembly resources and the default culture dictionary.
        /// </summary>
        ...
        private async Task CopyInto(IDictionary<string, string> dictionary, string resourcePath)
        {
            ...
            // If a Culture doesn't have a translation the stream will be null and it defaults to en-us further EntreLaunch the chain
            if (stream is null)
            {
        ...
        private static string GetResourceFilename(string culture)
        {
            ...
            if (parts.Length == 2)
            {
                culture = parts[0].ToLowerInvariant() + "-" + parts[1].ToEntreLaunchperInvariant();
            }
            else
            {
