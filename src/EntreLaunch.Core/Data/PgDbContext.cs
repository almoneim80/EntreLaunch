...
namespace EntreLaunch.Data
{
    public class PgDbContext : IdentityDbContext<User>
    {
        ...
        public virtual DbSet<ClubEventRegistration> ClubEventRegistrations { get; set; } = null!;
            ...
            try
            {
                ...
                optionsBuilder.UseNpgsql(
                    ...
                    b => b.MigrationsHistoryTable("_migrations")
                          .MigrationsAssembly("EntreLaunch.Web"))
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Consultation>()
                ...
                .WithMany(ct => ct.HistoricalConsultations)
