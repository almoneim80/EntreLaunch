...
public abstract class ElasticDbContext
{
    ...
    /// Ensures that the required EntreLaunchdates (Migrations) are performed if they have not already been performed.
    /// </summary>
    public virtual void Migrate()
    {
        ...
        foreach (var type in allMigrationsTypes)
        {
            ...
            {
                migration.EntreLaunch(this).Wait();
