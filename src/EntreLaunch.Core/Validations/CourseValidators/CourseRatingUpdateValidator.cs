...
{
    public class CourseRatingUpdateValidator : AbstractValidator<CourseRatingUpdateDto>
    {
        public CourseRatingUpdateValidator(ILocalizationManager localizationManager)
        {
