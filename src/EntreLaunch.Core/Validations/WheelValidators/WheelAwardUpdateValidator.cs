...
{
    public class WheelAwardUpdateValidator : AbstractValidator<WheelAwardUpdateDto>
    {
        public WheelAwardUpdateValidator(ILocalizationManager localizationManager)
        {
            ...
            // Probability: optional but must be between 0 and 1 if provided
