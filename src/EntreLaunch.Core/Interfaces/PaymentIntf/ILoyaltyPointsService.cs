...
namespace EntreLaunch.Interfaces.PaymentIntf
{
    public interface ILoyaltyPointsService
    {
        ...
        /// </summary>
        Task<GeneralResult<LoyaltyPointsResult>> AddPointsForPaymentAsync(string userId, int paymentId);

        /// <summary>
        /// deduct points from the user (if used for payment or any other reason).
        /// </summary>
        Task<GeneralResult<LoyaltyPointsResult>> DeductPointsAsync(string userId, int points);
        ...
        /// </summary>
        Task<GeneralResult<PaymentDetailsDto>> RedeemPointsForPaymentAsync(string userId, int paymentId, int pointsToUse);

        /// <summary>
        /// Add points as a reward to the user.
        /// </summary>
        Task<GeneralResult<LoyaltyPointsResult>> AddBonusPointsAsync(string userId, int points, string reason);
    }
}
