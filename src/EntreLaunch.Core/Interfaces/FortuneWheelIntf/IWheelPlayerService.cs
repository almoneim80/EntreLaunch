...
namespace EntreLaunch.Interfaces.FortuneWheelIntf
{
    public interface IWheelPlayerService
    {
        ...
        /// </summary>
        Task<GeneralResult<PaginatedResult<WheelPlayDto>>> GetPlaysByDeliveryStatusAsync(bool delivered, PaginationParams pagination, CancellationToken cancellationToken = default);

        /// <summary>
        /// Retrieves a list of all plays for the specified player.
        /// </summary>
        Task<GeneralResult<PaginatedResult<WheelPlayDto>>> GetAllUserPlaysAsync(PaginationParams pagination, CancellationToken cancellationToken = default);

        /// <summary>
        /// Retrieves a list of all physical item wheel plays across all users,
        /// optionally filtered by delivery status.
        /// </summary>
        Task<GeneralResult<PaginatedResult<WheelPlayDto>>> GetPhysicalItemPlaysByDeliveryStatusAsync(bool? isDelivered, PaginationParams pagination, CancellationToken cancellationToken = default);
