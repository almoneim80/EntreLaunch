...
namespace EntreLaunch.Interfaces.TrainingIntf
{
    public interface ITagService
    {
        ...
        /// Get all tags.
        /// </summary>
        Task<GeneralResult<PaginatedResult<Tag>>> GetAllTagsAsync(PaginationParams pagination, CancellationToken cancellationToken);
        ...
        /// Update tag.
        /// </summary>
        Task<GeneralResult> UpdateTagAsync(int tagId, string newTagName);
        ...
        /// </summary>
        Task<GeneralResult<List<string>>> GetCoursesByTagNameAsync(string tagName);
    }
}
