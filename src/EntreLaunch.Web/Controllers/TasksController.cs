namespace EntreLaunch.Controllers
{
    ...
    public class TasksController(IEnumerable<ITask> tasks, TaskRunner taskRunner, ILogger<TasksController> logger, ILocalizationManager localization) : AuthenticatedController(localization)
    {
        private readonly IEnumerable<ITask> tasks = tasks;
        private readonly TaskRunner taskRunner = taskRunner;
