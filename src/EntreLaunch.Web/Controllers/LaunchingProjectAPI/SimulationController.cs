...
{
    [Authorize(Roles = AppRoles.SimulationRoles)]
    [Route("api/[controller]")]
    public class SimulationController(
        ILogger<SimulationController> logger,
        CascadeDeleteService deleteService,
        ILocalizationManager localization,
        ISimulationService simulationService) : AuthenticatedController(localization)
    {
        ...
        public async Task<IActionResult> CreateSimulation([FromBody] SimulationCreateDto dto)
        {
            ...
            catch (Exception ex)
            {
                ...
                return this.UnexpectedError("creating simulation");
            }
        }
        ...
        public async Task<IActionResult> RegisterGuest([FromBody] GuestRegisterDto dto)
        {
            ...
            catch (Exception ex)
            {
                ...
                return this.UnexpectedError("registering guest");
            }
        }
        ...
        [ProducesResponseType(StatusCodes.Status401Unauthorized)]
        [AllowAnonymous]
        public async Task<IActionResult> LikeProductAd([FromRoute] int adId, [FromQuery] string userId)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                return this.UnexpectedError("liking product ad");
            }
        }
        ...
        /// </summary>
        [HttpPatch("update/{simulationId}")]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status204NoContent)]
        [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status404NotFound)]
        [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status500InternalServerError)]
        [ProducesResponseType(StatusCodes.Status401Unauthorized)]
        [RequiredPermission(SimulationPermissions.Update)]
        public async Task<IActionResult> UpdateSimulationStatus([FromRoute] int simulationId, [FromQuery] SimulationStatus newStatus)
        {
            try
            {
                var userCheck = CheckUserOrUnauthorized();
                ...
                var result = await _simulationService.UpdateSimulationStatusAsync(simulationId, newStatus);
                if (result.IsSuccess == false)
                    return BadRequest(result);
            ...
            {
                _logger.LogError(ex, "An error occurred in UpdateSimulationStatus.");
                return this.UnexpectedError("updating simulation status");
            }
        }
        ...
        public async Task<IActionResult> GetAllSimulations([FromQuery] PaginationParams pagination, CancellationToken cancellationToken)
        {
            try
            {
                var userCheck = CheckUserOrUnauthorized();
                ...
                var result = await _simulationService.GetAllSimulationsAsync(pagination, cancellationToken);
                if (!result.IsSuccess)
                {
                    return BadRequest(result);
                }
            ...
            catch (Exception ex)
            {
                ...
                return this.UnexpectedError("getting all simulations");
            }
        }
        ...
        public async Task<IActionResult> GetSimulationById([FromRoute] int simulationId)
        {
            ...
            catch (Exception ex)
            {
                ...
                return this.UnexpectedError("getting simulation by id");
            }
        }
        ...
        public async Task<IActionResult> GetSimulationAds([FromRoute] int simulationId)
        {
            ...
            catch (Exception ex)
            {
                ...
                return this.UnexpectedError("getting simulation ads");
            }
        }
        ...
        public async Task<IActionResult> GetSimulationsByStatus([FromQuery] SimulationStatus status)
        {
            try
            {
                var userCheck = CheckUserOrUnauthorized();
            ...
            catch (Exception ex)
            {
                ...
                return this.UnexpectedError("getting simulations by status");
            }
        }
        ...
        public async Task<IActionResult> GetLikeCount([FromRoute] int adId)
        {
            ...
            catch (Exception ex)
            {
                ...
                return this.UnexpectedError("getting like count");
            }
        }
        ...
        public async Task<IActionResult> DeleteSimulation([FromRoute] int simulationId)
        {
            ...
            catch (Exception ex)
            {
                ...
                return this.UnexpectedError("deleting simulation");
            }
        }
    }
}
