        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    certificate_validity_in_days = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_club_event_registrations", x => x.id);
                    table.ForeignKey(
                        name: "fk_club_event_registrations_club_events_event_id",
                        column: x => x.event_id,
                        principalTable: "club_events",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_club_event_registrations_users_user_id",
                        column: x => x.user_id,
                        principalTable: "users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    certificate_type = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "fk_certificates_training_paths_path_id",
                        column: x => x.path_id,
                        principalTable: "training_paths",
                        principalColumn: "id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    end_date = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    is_auto_renewal = table.Column<bool>(type: "boolean", nullable: false),
                    next_renewal_date = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    renewal_count = table.Column<int>(type: "integer", nullable: false),
                    is_gifted = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_student_lesson_completions", x => x.id);
                    table.ForeignKey(
                        name: "fk_student_lesson_completions_courses_course_id",
                        column: x => x.course_id,
                        principalTable: "courses",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_student_lesson_completions_lessons_lesson_id",
                        column: x => x.lesson_id,
                        principalTable: "lessons",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_student_lesson_completions_users_user_id",
                        column: x => x.user_id,
                        principalTable: "users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    user_id = table.Column<string>(type: "text", nullable: true),
                    course_id = table.Column<int>(type: "integer", nullable: true),
                    last_lesson_id = table.Column<int>(type: "integer", nullable: true),
                    path_id = table.Column<int>(type: "integer", nullable: true),
                    is_completed = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_student_progresses_training_paths_path_id",
                        column: x => x.path_id,
                        principalTable: "training_paths",
                        principalColumn: "id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "ix_club_event_registrations_event_id",
                table: "club_event_registrations",
                column: "event_id");

            migrationBuilder.CreateIndex(
                name: "ix_club_event_registrations_user_id",
                table: "club_event_registrations",
                column: "user_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_student_lesson_completions_course_id",
                table: "student_lesson_completions",
                column: "course_id");

            migrationBuilder.CreateIndex(
                name: "ix_student_lesson_completions_lesson_id",
                table: "student_lesson_completions",
                column: "lesson_id");

            migrationBuilder.CreateIndex(
                name: "ix_student_lesson_completions_user_id",
                table: "student_lesson_completions",
                column: "user_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_student_progresses_path_id",
                table: "student_progresses",
                column: "path_id");
