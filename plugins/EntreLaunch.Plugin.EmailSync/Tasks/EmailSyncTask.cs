...
using EntreLaunch.Tasks;
using Serilog;
using EntreLaunch.Data;
using EntreLaunch.Interfaces.EmailIntf;
using EntreLaunch.Services.TaskSvc;

namespace EntreLaunch.EmailSync.Tasks
{
    public class EmailSyncTask : BaseTask
    {
        ...
        public EmailSyncTask(IConfiguration configuration, PgDbContext dbContext, TaskStatusService taskStatusService, IDomainService domainService, IContactService contactsService)
