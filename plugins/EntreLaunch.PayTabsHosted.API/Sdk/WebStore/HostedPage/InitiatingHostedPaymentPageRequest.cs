...
{
    /// <summary>
    /// Start a new payment process on a hosted page with basic process settings.
    /// </summary>
#nullable disable
    public class InitiatingHostedPaymentPageRequest : ApiRequestBody
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InitiatingHostedPaymentPageRequest"/> class.
        /// </summary>
        public InitiatingHostedPaymentPageRequest(int profileId, string transactionType, string transactionClass, string cartId, string cartCurrency, decimal cartAmount, string cartDescription)
        {
            ProfileId = profileId;
