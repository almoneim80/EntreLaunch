...
{
    /// <summary>
    /// A response to hosted payment page operations, containing details such as the operation reference, results, and links
    /// </summary>
#nullable disable
    public class HostedPaymentPageResponse : PayTabsResponse
    {
