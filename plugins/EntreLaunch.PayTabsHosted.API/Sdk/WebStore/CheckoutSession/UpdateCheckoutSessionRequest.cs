...
{
    /// <summary>
    /// A request to EntreLaunchdate an existing payment session with a modification to the basket, customer, or payment methods.
    /// </summary>
#nullable disable
    public class EntreLaunchdateCheckoutSessionRequest : ApiRequestBody
    {
        /// <summary>
