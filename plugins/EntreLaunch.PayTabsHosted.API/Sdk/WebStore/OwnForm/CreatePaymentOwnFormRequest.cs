...
{
    /// <summary>
    /// This is a request to create a customized payment page using customer and basket data.
    /// </summary>
#nullable disable
    public class CreatePaymentOwnFormRequest : CreatePaymentBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreatePaymentOwnFormRequest"/> class.
        /// Create Payment Page - General.
        /// </summary>
        public CreatePaymentOwnFormRequest(CreatePaymentBase createPaymentBase, string payPageLang, CustomerDetails customerDetails, ShippingDetails shippingDetails, string callbackUrl, string returnUrl)
        {
        ...
        /// </summary>
        public CreatePaymentOwnFormRequest(CreatePaymentBase createPaymentBase, string[] paymentMethods, string payPageLang, CustomerDetails customerDetails, ShippingDetails shippingDetails, string callbackUrl, string returnUrl)
        {
            ProfileId = createPaymentBase.ProfileId;
            TransactionType = createPaymentBase.TransactionType;
            TransactionClass = createPaymentBase.TransactionClass;
        ...
        /// </summary>
        public CreatePaymentOwnFormRequest(CreatePaymentBase createPaymentBase, string[] paymentMethods, string payPageLang, CustomerDetails customerDetails, string callbackUrl, string returnUrl, bool hideShipping, string customerRef, InvoiceData invoice)
        {
            ProfileId = createPaymentBase.ProfileId;
            TransactionType = createPaymentBase.TransactionType;
            TransactionClass = createPaymentBase.TransactionClass;
