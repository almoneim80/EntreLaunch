...
{
#nullable disable
    public class CreateApplePayDirectPaymentRequest : ApiRequestBody
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateApplePayDirectPaymentRequest"/> class.
        /// Creates a new ApplePay direct payment request.
        /// </summary>
        public CreateApplePayDirectPaymentRequest(int profileId, string transactionType, string region, string transactionClass, string cartId, string cartCurrency, decimal cartAmount, string cartDescription)
        {
            ProfileId = profileId;
