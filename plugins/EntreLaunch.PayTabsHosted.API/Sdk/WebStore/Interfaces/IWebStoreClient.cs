...
#nullable disable
    public interface IWebStoreClient : IClient
    {
        ...
        /// <summary>
        /// Updates a hosted payment page.
        /// </summary>
        HostedPaymentPageResponse UpdateHostedPaymentPage(UpdateHostedPaymentPageRequest body, Dictionary<string, string> headers = null);
        ...
        /// <summary>
        /// FinalizeHostedPaymentPage API which enables Pay to validate payment critical attributes and also update book-keeping attributes present in merchantMetadata.
        /// </summary>
        ...
        /// </summary>
        CheckoutSessionResponse UpdateCheckoutSession(UpdateCheckoutSessionRequest body, Dictionary<string, string> headers = null);
